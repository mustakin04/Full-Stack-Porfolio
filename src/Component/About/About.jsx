            ...
            <div className="w-[50%]" data-aos="fade-left">
              ...
              <div className="font-poppins text-white ">
                ...
                <p className="font-normal text-[22px] text-justify">
                  ...
                  strong work ethic and a commitment to continuous learning. I
                  possess deep knowledge and hands-on experience in JavaScript,
                  React.js, Next.js, Express.js, MongoDB, and MySQL, along with
                  expertise in building mobile-responsive and user-friendly web
                  applications. I take pride in writing secure, efficient, and
                  scalable code that is clean, maintainable, and easy to read.
                  My enthusiasm for creativity and attention to detail drive me
                  to deliver high-quality solutions that meet both technical and
                  business needs.
                </p>
